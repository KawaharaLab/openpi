...
class Observation(Generic[ArrayT]):
    ...
    # Force/torque readings, with same keys as FORCE_TORQUE_KEYS.
    force_torques: dict[str, at.Float[ArrayT, "*b fh fd"]]
    ...
    def from_dict(cls, data: at.PyTree[ArrayT]) -> "Observation[ArrayT]":
        ...
        return cls(
            ...
            force_torques=data["force_torques"],
            state=data["state"],
    ...
    def to_dict(self) -> at.PyTree[ArrayT]:
        ...
        result["force_torques"] = result.pop("force_torques")
        return result
...
def preprocess_observation(
    ...
    *,
    ...
    for key in FORCE_TORQUE_KEYS:
        if key not in observation.force_torques:
            # fill with zeros by default
            out_fts[key] = jnp.zeros(batch_shape + (FT_HORIZON, 6), dtype=jnp.float32)
        else:
            out_fts[key] = jnp.asarray(observation.force_torques[key])
