  ...
  bash -lc "
    ...
    torchrun \
      ...
      scripts/train_pytorch.py pi0_ur3_robotiq_ft \
        --resume \
        --exp_name sweet-cherry-23 \
        --batch_size 128 \
            --num_workers 16 \
        --no-pytorch-gradient-checkpointing \
            --ft_action_head_steps 10000 \
            --ft_no_cnn_steps 60000 \
            --ft_cnn_only_steps 0 \
            --num_train_steps 60000 \
            --pytorch_weight_path /work/gr41/r41000/openpi/checkpoints/pi0_ur3_robotiq_ft/sweet-cherry-23/40000/ \
        --save_interval 5000
  "